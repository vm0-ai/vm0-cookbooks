...
# Bright Data Instagram Scraper - Trigger Script
# Usage: ./trigger-scrape.sh "search_keyword"

API_URL="https://api.brightdata.com/datasets/v3/trigger"
DATASET_ID="${BRIGHTDATA_DATASET_ID:-gd_lyclm20il4r5helnj}"
...
if [ -z "$1" ]; then
    ...
    echo "Usage: ./trigger-scrape.sh \"fitness\""
    exit 1
fi
...
echo "Triggering Instagram scrape for keyword: $KEYWORD"
echo "Results limit: $LIMIT"

# Build request body - using keyword search
